...
class PromptProcessor:
    def __init__(self,
        ...
        self.set_config(topic, concept_type, prompts, prompts_path, min_words, intro_words)
        self.split_prefix = split_prefix
        self.special_tokens = [re.compile('<*/?SYS>*'), re.compile('\[/?INST\]')]
        self.to_regenerate = {'too short': [], 'has intro': []}
    
    def set_config(self, topic, concept_type, prompts, prompts_path, min_words, intro_words):
        if self.config_path:
        ...
        self.prompts_path = prompts_path or f'generated_prompts/{self.topic}/{self.concept_type} ({self.topic}).json'
